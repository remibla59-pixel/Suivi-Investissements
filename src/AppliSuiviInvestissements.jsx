...
// ⚠️ REMPLACEZ CES LIGNES PAR VOTRE PROPRE CONFIGURATION FIREBASE ⚠️
...
const InvestmentTrackerApp = () => {
  ...
  const handleExport = () => {
    const blob = new Blob([JSON.stringify({ brokers, patrimonyGoal, targetAllocation, version: "1.7.1" }, null, 2)], { type: 'application/json' });
