...
import { AreaChart, Area, Line, CartesianGrid, XAxis, YAxis, Tooltip, Legend, ReferenceLine, ResponsiveContainer } from "recharts";
import { BlurMoney, inputClass, labelClass } from "../ui.jsx";
import { formatCompactAxis } from "../../utils/calculs.js";

export const SimulationView = ({ currentTotal, globalTRI, globalTWR, patrimonyGoal, privacyMode }) => {
